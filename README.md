...
- All in all, window modes, geometry, rotation and many smaller things are often subtly broken depending on which Qt version is used. Using only Qt 6.8 and up helps a lot...
